...
export default function Navbar() {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    if (searchTerm.trim()) {
      // CAMBIO: Ahora redirige a la página de búsqueda global unificada
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:block flex-1 max-w-sm">
            <form onSubmit={handleSearch} className="relative group">
              <input
                ...
                placeholder="Buscar cartas, cajas, sets..."
                value={searchTerm}
          ...
          <div className="flex items-center space-x-6 ml-4">
            <div className="relative cursor-pointer group">
              ...
              <span className="absolute -top-2 -right-2 bg-red-600 text-white text-[10px] font-bold rounded-full h-4 w-4 flex items-center justify-center shadow-sm">
                0
              </span>
            </div>
